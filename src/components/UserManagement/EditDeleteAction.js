...
const EditDeleteActionForUser = (props) => {
    ...
    return (
        <Fragment>
            ...
            <Confirmation
                ...
                des={`Delete ${row?.name} !`} />
            <EditUser Id={Id} openEdit={openEdit} setOpenEdit={setOpenEdit} type={type} row={row}/>
        </Fragment>

    )
}

export default connect(null, { DELETE_MODULE_FROM_ADMIN })(EditDeleteActionForUser);
